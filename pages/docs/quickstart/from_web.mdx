...
> If you are interested in `ChatModel` (for chatbot), contact us on [discord](https://discord.gg/2Y36M36tZf).
> {/* please check [ChatModel Editor](/docs/webpage/development_dashboard/chatmodel) */}

### Create your first PromptModel

Create your first PromptModel with an appropriate name.
