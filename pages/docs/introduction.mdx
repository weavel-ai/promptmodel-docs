...
- Codebase synchronization that allows you to simply add a new PromptModel/ChatModel in your code and have it automatically appear in the dashboard.
...
| Storage                        |      Cloud       |        Cloud        |
| PromptModel/ChatModel creation |     From web     |  From web or code   |
