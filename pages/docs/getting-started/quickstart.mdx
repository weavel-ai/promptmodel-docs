...
> We are currently in closed alpha. If you would like to try out Promptmodel, please [request access](https://formless.ai/c/RtUfMCsh9YSs).
...
Output format that is currently supported and will be parsed looks like:
