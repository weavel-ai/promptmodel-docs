...
**ChatModel**'s methods `run` and `arun` return either an `LLMResponse` or `LLMStreamResponse` object same as [**FunctionModel**](/docs/integrations/python-sdk/promptmodel).
